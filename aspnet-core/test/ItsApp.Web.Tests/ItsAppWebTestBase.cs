...
{
    public abstract class ItsAppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ItsAppWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ItsAppWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ItsAppDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ItsAppDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ItsAppDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ItsAppDbContext, Task<T>> func)
        {
            T result;
