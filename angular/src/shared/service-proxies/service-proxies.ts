...
@Injectable()
export class InformationServiceServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getStepIndexList(): Observable<number[]> {
        let url_ = this.baseUrl + "/api/services/app/InformationService/GetStepIndexList";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetStepIndexList(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetStepIndexList(<any>response_);
                } catch (e) {
    ...
    protected processGetStepIndexList(response: HttpResponseBase): Observable<number[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * @param stepIndex (optional) 
     * @return Success
     */
    getByStepIndex(stepIndex: number | undefined): Observable<InformationDto[]> {
        let url_ = this.baseUrl + "/api/services/app/InformationService/GetByStepIndex?";
        if (stepIndex === null)
            throw new Error("The parameter 'stepIndex' cannot be null.");
        else if (stepIndex !== undefined)
            url_ += "stepIndex=" + encodeURIComponent("" + stepIndex) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetByStepIndex(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetByStepIndex(<any>response_);
                } catch (e) {
                    return <Observable<InformationDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<InformationDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetByStepIndex(response: HttpResponseBase): Observable<InformationDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(InformationDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<InformationDto[]>(<any>null);
    }
     ...
     * @return Success
     */
    createOrUpdate(body: InformationDto | undefined): Observable<number> {
        let url_ = this.baseUrl + "/api/services/app/InformationService/CreateOrUpdate";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<InformationDto> {
        let url_ = this.baseUrl + "/api/services/app/InformationService/Get?";
        if (id === null)
    ...
    protected processGet(response: HttpResponseBase): Observable<InformationDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = InformationDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
    ...
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/InformationService/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
     ...
     * @return Success
     */
    deleteByStepIndex(stepIndex: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/InformationService/DeleteByStepIndex?";
        if (stepIndex === null)
            throw new Error("The parameter 'stepIndex' cannot be null.");
        else if (stepIndex !== undefined)
            url_ += "stepIndex=" + encodeURIComponent("" + stepIndex) + "&";
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteByStepIndex(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteByStepIndex(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDeleteByStepIndex(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class InformationDto implements IInformationDto {
    ...
    constructor(data?: IInformationDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.stepIndex = _data["stepIndex"];
            this.id = _data["id"];
        }
    }

    static fromJS(data: any): InformationDto {
        data = typeof data === 'object' ? data : {};
        let result = new InformationDto();
        result.init(data);
        return result;
    }
